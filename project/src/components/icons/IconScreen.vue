...
const props = defineProps({
  /** @property Width - Ширина иконки */
  width: {
    type: Number,
    default: 24
  },

  /** @property Height - Высота иконки */
  height: {
    type: Number,
    default: 24
  },

  /** @property isFullScreen - Полноэкранный режим */
  isFullScreen: {
    type: Boolean,
    default: false
  }
...
const arrowAngle = computed(() => props.isFullScreen ? 180 : 0)

const arrowUp = computed(() => `rotate(${arrowAngle.value}, 8, 10)`)
const arrowDown = computed(() => `rotate(${arrowAngle.value}, 16.5, 14.5)`)
